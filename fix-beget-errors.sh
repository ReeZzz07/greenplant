...
echo "📝 Шаг 3: Проверка миграций..."
php artisan migrate:status
echo ""

# Шаг 4: Выполнение миграций (если нужно)
echo "📝 Шаг 4: Выполнение миграций..."
...
echo "📝 Шаг 5: Заполнение базы данных..."
...
# Шаг 6: Создание символической ссылки
echo "📝 Шаг 6: Создание символической ссылки storage..."
php artisan storage:link
echo "✅ Символическая ссылка создана"
echo ""

# Шаг 7: Установка прав доступа
echo "📝 Шаг 7: Установка прав доступа..."
chmod -R 775 storage bootstrap/cache
chmod -R 777 storage/logs
echo "✅ Права доступа установлены"
echo ""

# Шаг 8: Создание кэша конфигурации
echo "📝 Шаг 8: Создание кэша конфигурации..."
...
echo "📝 Шаг 9: Последние записи в логах Laravel..."
echo "════════════════════════════════════════════════════════════"
