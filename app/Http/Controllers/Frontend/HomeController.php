...
$q->where('slug', $request->category);
    ...
    {
        $defaultContent = '<h2>1. Общие положения</h2>
<p>Настоящая Политика конфиденциальности определяет порядок обработки и защиты персональных данных пользователей сайта GreenPlant (далее — «Сайт»).</p>
...
<ul>
    ...
    <li>Информирование о новых товарах и акциях (только с согласия клиента)</li>
</ul>

<h2>4. Защита данных</h2>
<p>Мы принимаем все необходимые меры для защиты ваших персональных данных от неправомерного доступа, изменения, раскрытия или уничтожения.</p>

<h2>5. Передача данных третьим лицам</h2>
<p>Мы не передаем ваши персональные данные третьим лицам, за исключением случаев, когда это необходимо для выполнения заказа (службы доставки, платежные системы).</p>
...
<h2>7. Контакты</h2>
<p>По всем вопросам, связанным с обработкой персональных данных, вы можете обращаться по адресу: ' . Setting::get('email', 'info@greenplant.ru') . '</p>
...
<p>Мы оставляем за собой право вносить изменения в настоящую Политику конфиденциальности. Актуальная версия всегда доступна на этой странице.</p>';
        ...
        $savedContent = Setting::get('privacy_policy_content', '');
        // Проверяем, что контент не пустой (убираем HTML теги и пробелы)
        $savedContentStripped = strip_tags(trim($savedContent));
        $content = !empty($savedContentStripped) ? $savedContent : $defaultContent;
    ...
    {
        $defaultContent = '<h2>1. Общие положения</h2>
<p>Настоящее Пользовательское соглашение (далее — «Соглашение») регулирует отношения между интернет-магазином GreenPlant (далее — «Продавец») и пользователем сайта (далее — «Покупатель»).</p>
<p>Используя Сайт и совершая покупки, вы подтверждаете, что ознакомились с условиями настоящего Соглашения и согласны с ними.</p>

<h2>2. Предмет соглашения</h2>
<p>Продавец обязуется продать, а Покупатель обязуется купить товар на условиях, указанных в настоящем Соглашении.</p>

<h2>3. Оформление заказа</h2>
<p>Заказ оформляется путем добавления товара в корзину и заполнения формы заказа. Покупатель обязуется предоставить достоверную информацию при оформлении заказа.</p>

<h2>4. Цены и оплата</h2>
<p>Цены на товары указаны на Сайте. Продавец оставляет за собой право изменять цены без уведомления Покупателя.</p>
<p>Оплата производится способами, указанными на Сайте в момент оформления заказа.</p>

<h2>5. Доставка</h2>
<p>Доставка товаров осуществляется способами и в сроки, указанные на Сайте. Стоимость доставки рассчитывается индивидуально и сообщается Покупателю при оформлении заказа.</p>

<h2>6. Возврат товара</h2>
<p>Возврат товара надлежащего качества возможен в течение 7 дней с момента получения товара, при условии сохранения товарного вида и потребительских свойств.</p>
<p>Возврат товара ненадлежащего качества осуществляется в соответствии с законодательством РФ.</p>

<h2>7. Гарантии</h2>
<p>Продавец гарантирует качество продаваемых товаров и предоставляет гарантию приживаемости при соблюдении рекомендаций по посадке и уходу.</p>

<h2>8. Ответственность сторон</h2>
<p>Продавец не несет ответственности за ущерб, причиненный Покупателю в результате неправильного использования товара или несоблюдения рекомендаций по уходу.</p>

<h2>9. Разрешение споров</h2>
<p>Все споры решаются путем переговоров. При невозможности достижения соглашения споры разрешаются в соответствии с законодательством РФ.</p>

<h2>10. Контакты</h2>
<p>По всем вопросам вы можете обращаться по адресу: ' . Setting::get('email', 'info@greenplant.ru') . ' или по телефону: ' . Setting::get('phone', '+7 (495) 123-45-67') . '</p>

<h2>11. Изменения в Соглашении</h2>
<p>Продавец оставляет за собой право вносить изменения в настоящее Соглашение. Актуальная версия всегда доступна на этой странице.</p>';

        $savedContent = Setting::get('terms_of_service_content', '');
        // Проверяем, что контент не пустой (убираем HTML теги и пробелы)
        $savedContentStripped = strip_tags(trim($savedContent));
        $content = !empty($savedContentStripped) ? $savedContent : $defaultContent;
