...
<head>
    ...
    <title>Редактировать настройки страницы каталога - GreenPlant</title>
    <style>
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            <h2>✏️ Редактировать настройки страницы каталога</h2>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.catalog-page-settings.update', $setting->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        @if($setting->background_image)
                            <div class="current-image">
                                ...
                                <img src="{{ asset('storage/' . $setting->background_image) }}" alt="Current" class="image-preview" id="current-image">
                            </div>
                        @endif
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $setting->title) }}" placeholder="Например: Каталог товаров">
                        <small>Основной заголовок страницы каталога</small>
                    </div>

                    <div class="form-group">
                        <label for="subtitle">Подзаголовок (опционально)</label>
                        <textarea name="subtitle" id="subtitle" placeholder="Например: Широкий ассортимент саженцев и деревьев туи">{{ old('subtitle', $setting->subtitle) }}</textarea>
