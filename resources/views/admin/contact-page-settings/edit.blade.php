            ...
            <div class="card-body">
                <form action="{{ route('admin.contact-page-settings.update', $setting->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="consent_text" id="consent_text" rows="3" placeholder='Нажимая кнопку "Отправить сообщение", Вы соглашаетесь с условиями "Политики конфиденциальности" и "Пользовательским соглашением"'>{{ old('consent_text', $setting->consent_text) }}</textarea>
