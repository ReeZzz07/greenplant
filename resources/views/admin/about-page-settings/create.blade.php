...
<head>
    ...
    <title>Создать настройки страницы "О компании" - GreenPlant</title>
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            <h2>➕ Создать настройки страницы "О компании"</h2>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.about-page-settings.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div id="preview-box" style="width: 100%; height: 200px; border: 2px solid #e9ecef; border-radius: 10px; position: relative; overflow: hidden; background: #f8f9fa; display: flex; align-items: center; justify-content: center;">
                            ...
                            <div id="preview-content" style="position: relative; z-index: 1; text-align: center; color: white; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">
                                <h3 style="margin: 0; font-size: 24px;">О компании GreenPlant</h3>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', 'О компании GreenPlant') }}" placeholder="Например: О компании GreenPlant">
                    </div>

                    <div class="form-group">
                        <label for="subtitle">Подзаголовок (опционально)</label>
                        <textarea name="subtitle" id="subtitle" placeholder="Например: Мы специализируемся на выращивании и продаже различных сортов туи">{{ old('subtitle') }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="welcome_title" id="welcome_title" value="{{ old('welcome_title', 'Добро пожаловать в GreenPlant') }}" placeholder="Например: Добро пожаловать в GreenPlant">
                    </div>

                    <div class="form-group">
                        <label for="welcome_text">Текст приветствия</label>
                        <textarea name="welcome_text" id="welcome_text" placeholder="Например: GreenPlant - это питомник растений...">{{ old('welcome_text') }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="main_content">Дополнительный контент</label>
                        <textarea name="main_content" id="main_content" placeholder="Дополнительная информация о компании...">{{ old('main_content') }}</textarea>
                    </div>
